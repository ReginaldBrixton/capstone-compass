    ...
    variant === 'colored'
      ? `${
          isOpen
            ...
            : 'hover:bg-blue-50/50 dark:hover:bg-blue-900/10 hover:text-blue-600 dark:hover:text-blue-300'
        } active:bg-blue-100 dark:active:bg-blue-900/30`
      : `${
          isOpen
            ? 'bg-gray-50 dark:bg-gray-800/50'
            : 'hover:bg-gray-50/50 dark:hover:bg-gray-800/25'
        } active:bg-gray-100 dark:active:bg-gray-800/75`;
