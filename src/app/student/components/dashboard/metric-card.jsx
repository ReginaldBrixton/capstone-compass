...
const MetricCard = ({ title, value, change, icon, className }) => {
  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        className="pointer-events-none absolute inset-0 opacity-50 sm:opacity-30 md:opacity-20" // Adjust opacity for different screen sizes
        id="metric-card-bg-canvas"
        style={{ width: '100%', height: '100%' }}
      />
      <CardContent
        className="relative z-10 p-6 md:p-8"
        id="metric-card-content"
      >
        <div
        ...
        >
          <div
            ...
            id="metric-card-title-value-container"
          >
            <p
            ...
            <p className="text-2xl font-bold" id="metric-card-value">
              {value}
            </p>
          </div>
          <div
