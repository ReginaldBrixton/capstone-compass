    ...
    <>
      ...
      >
        <div className="relative">
          ...
          {story.isLive && (
            <div className="absolute bottom-0 left-0 right-0 bg-red-500 text-white text-[10px] text-center rounded-b-full">
              LIVE
            </div>
          )}
          {story.isPremium && (
      ...
      {/* Story Preview Modal */}
      {showPreview && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center" id="story-modal">
          <button
