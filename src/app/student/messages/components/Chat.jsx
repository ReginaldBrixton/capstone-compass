...
const Chat = () => {
  ...
  return (
    <div className="chat-container" data-oid="4xt12.p">
      <div className={`chat-list-container ${showChatList ? 'visible' : ''}`} data-oid="qep6y0r">
        <ChatList
          chats={chats}
      ...
      {selectedChat && (
        <div className="chat-window-container" data-oid="jx0wh38">
          <ChatHeader
            ...
            data-oid="uw6v-xi"
          />
          <ChatWindow messages={messages} onContextMenu={handleContextMenu} data-oid="3xv3.x1" />
          <MessageInput
