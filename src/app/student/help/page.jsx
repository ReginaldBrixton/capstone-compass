...
export default function HelpPage() {
  ...
  return (
    <div
      ...
      data-oid="8v9b6dl"
    >
      <main className="mx-auto max-w-7xl p-4 md:p-8" role="main" data-oid="6-:hyr2">
        <motion.h1
          initial={{
            opacity: 0,
            y: -20,
        ...
        >
          Help & Support
          <span className="mx-auto mt-2 block h-1 w-12 rounded-sm bg-blue-500" data-oid="0z7xk0r" />
        </motion.h1>
          ...
          {isModalOpen && selectedCategory && (
            ...
            >
              ...
              >
                ...
                <p className="leading-relaxed text-gray-600" data-oid="6:-zci-">
