...
const DefaultMegaMenu = () => {
  return (
    <div className="default-mega-menu">
      <h2 className="mb-4 text-xl font-semibold">Default Mega Menu</h2>
      <MegaMenu
        variant="default"
        brandName="Company"
...
const IconMegaMenu = () => {
  return (
    <div className="icon-mega-menu">
      <h2 className="mb-4 text-xl font-semibold">Icon Mega Menu</h2>
...
const FullWidthMegaMenu = () => {
  return (
    <div className="full-width-mega-menu">
      <h2 className="mb-4 text-xl font-semibold">Full Width Mega Menu</h2>
      <MegaMenu
        variant="full-width"
        brandName="Company"
        menuItems={defaultMenuItems}
...
const FullWidthCtaMegaMenu = () => {
  return (
    <div className="full-width-cta-mega-menu">
      <h2 className="mb-4 text-xl font-semibold">Full Width with CTA</h2>
      <MegaMenu
